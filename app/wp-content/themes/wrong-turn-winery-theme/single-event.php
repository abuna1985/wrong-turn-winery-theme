<?php
  ...
  while(have_posts()) {
    ...
    <div class="page-banner">
      <div class="page-banner__bg-image" style="background-image: url(<?php echo get_theme_file_uri('/images/bottles.jpg'); ?>);"></div>
    ...
    <div class="metabox metabox--position-up metabox--with-home-link">
      ...
      <?php 
        ...
        if($relatedPrograms){
          ...
          echo '<h2 class="headline headline--medium">Related Wine(s)</h2>';
